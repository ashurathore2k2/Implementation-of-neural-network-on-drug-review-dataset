...
Train_dataset=pd.read_csv('/home/himanshu/Downloads/ML Project DRD/drugLib_raw/drugLibTrain_raw.tsv', sep='\t')
Test_dataset=pd.read_csv('/home/himanshu/Downloads/ML Project DRD/drugLib_raw/drugLibTest_raw.tsv', sep='\t')
...
# performing concatenation to join benifits_review, side_effects_review and comments into a Report attribute to predict the overall satisfaction of patients
...
# Labelling of ratings as Positive, Negative and Neutral for sentiment classification
